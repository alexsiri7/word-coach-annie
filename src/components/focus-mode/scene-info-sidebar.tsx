...
import { ChevronLeft, ChevronRight, Hash, Clock, FileText, Target } from "lucide-react";
...
export function SceneInfoSidebar({
    ...
    if (collapsed) {
        return (
            <div className="w-12 border-r bg-background flex flex-col items-center py-4 gap-4 h-screen">
        ...
        <div className="w-80 border-r bg-background flex flex-col h-screen">
            ...
            <div className="p-4 border-t bg-muted/10 space-y-2">
                ...
                <Button variant="ghost" className="w-full text-xs text-muted-foreground h-8" asChild>
                    <a href={`/project/${projectId}`}>Back to Dashboard</a>
                </Button>
            </div>
        </div>
    );
