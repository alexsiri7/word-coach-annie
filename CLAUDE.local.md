...
| Ask Witness for help | `gt mail send word_coach_annie/witness -s "HELP" -m "..."` | ~~gt nudge witness~~ |

---

## When to Ask for Help

Mail your Witness (`word_coach_annie/witness`) when:
...
```bash
gt mail send word_coach_annie/witness -s "HELP: <problem>" -m "Issue: ...
Problem: ...
Tried: ...
Question: ..."
```
