...
Run **five** parallel AI reviewer personas (Publisher, Avid Reader, Experienced Writer, Comedy Writer, Acting Coach) against
...
```json
{
  ...
  "actor": { "...same shape as publisher, nullable — absent on pre-actor reviews..." },
  "consensus": {
